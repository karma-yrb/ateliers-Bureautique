...
function renderExerciseFeedbackModal() {
  return `  <style>
    ...
    .feedback-toggle-option input[value="easy"]:checked + span {
      background: #dff3e6;
      color: #1f5b35;
    }

    .feedback-toggle-option input[value="adapted"]:checked + span,
    .feedback-toggle-option input[value="medium"]:checked + span,
    .feedback-toggle-option input[value="partial"]:checked + span {
      background: #fff1cf;
      color: #815a00;
    }

    .feedback-toggle-option input[value="hard"]:checked + span,
    .feedback-toggle-option input[value="unclear"]:checked + span,
    .feedback-toggle-option input[value="assisted"]:checked + span {
      background: #fde0dc;
      color: #7d2e24;
    }

    .feedback-toggle-option input[value="clear"]:checked + span,
    .feedback-toggle-option input[value="independent"]:checked + span {
      background: #e0eefc;
      color: #214c82;
    }

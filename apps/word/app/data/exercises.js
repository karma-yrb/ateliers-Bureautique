window.WORD_ATELIER_DATA = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "consignes": [],
      "instructions": [
        "Reproduisez la mise en page du resultat attendu.",
        "Appliquez une lettrine avec une police decorative proche de 'SF Comic Script Shaded' ou une alternative deja installee.",
        "Respectez les ecarts et le nombre de lignes occupes par chaque lettrine."
      ],
      "scrape": {
        "ok": true,

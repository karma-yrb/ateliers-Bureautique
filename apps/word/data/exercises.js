window.WORD_ATELIER_DATA = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "description": "Telechargez le fichier de travail. La police conseillee pour les lettrines est 'SF Comic Script Shaded'. Si elle n'est pas installee, telechargez-la depuis Dafont ou utilisez une police decorative proche deja presente sur l'ordinateur. Bien respecter les ecarts et le nombre de lignes occupes par les lettrines.",
      "consignes": [],
      "instructions": [

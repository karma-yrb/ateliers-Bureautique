window.EXCEL_ATELIER_DATA = {
  ...
  "exercises": [
    ...
    },
    {
      ...
      "preamble": "",
      "instructions": [
        "Reproduisez les différentes sélections visibles sur l'image de l'énoncé.",
        "Pour sélectionner une plage de cellules, cliquez sur la première cellule, maintenez le bouton gauche enfoncé, puis faites glisser jusqu'à la dernière cellule.",
        "Pour sélectionner une ligne ou une colonne entière, cliquez sur son numéro (ligne) ou sa lettre (colonne).",
        "Pour modifier la hauteur d'une ligne ou la largeur d'une colonne, faites un clic droit sur son numéro ou sa lettre, puis choisissez « Hauteur de ligne » ou « Largeur de colonne ».",
        "Attention : la hauteur des lignes et la largeur des colonnes n'utilisent pas la même échelle. Une même valeur ne donnera pas la même taille à l'écran.",
        "Pour sélectionner plusieurs zones non adjacentes, maintenez la touche Ctrl enfoncée pendant vos sélections.",
        "Comparez votre résultat avec l'image de l'énoncé avant de passer à la suite."
      ],
      "levelLabel": "Debutant",
      "scrape": {
        "ok": true,
